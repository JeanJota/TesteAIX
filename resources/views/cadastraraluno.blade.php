                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation" id="app">
                                    <form class="form-valide" action="{{ route('aluno.create') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="turma" placeholder="Turma" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="date" class="form-control" name="datamtr" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="uf" id="estado" placeholder="Estado" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="complemento" id="complemento" placeholder="Ex.: Ap 101 Bl. 03" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
